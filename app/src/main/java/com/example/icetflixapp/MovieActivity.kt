...
import com.example.icetflixapp.model.MovieDetail
import com.example.icetflixapp.util.DownloadImageTask
import com.example.icetflixapp.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=f02ef0c4-3854-4c2b-9648-958a68c315c5"
